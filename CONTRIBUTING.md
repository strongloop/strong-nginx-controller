...
Thank you for your interest in `strong-nginx-controller`, an open source project
administered by StrongLoop.

Contributing to `strong-nginx-controller` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/strongloop/strong-nginx-controller)
